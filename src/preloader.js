...
Community.Preloader.prototype = {
	...
	loadImages: function() {
        ...
        this.load.image('backSprite', 'assets/images/backToMenu.png');
        this.load.image('StatsSprite', 'assets/images/displayStats.png');
	...
	loadScripts: function() {
		...
		this.load.script('saver', 'src/saver.js');
		this.load.script('play', 'src/play.js');
	},
	...
	addGameStates: function() {
		...
		this.state.add('Play', Community.Play);
		this.state.add('Saver', Community.Saver);
	}
